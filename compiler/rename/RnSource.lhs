...
rnFamDecl mb_cls (FamilyDecl { fdLName = tycon, fdTyVars = tyvars
  ...
  = do { ((tycon', tyvars', kind', injectivity'), fv1) <-
           ...
           do { tycon' <- lookupLocatedTopBndrRn tycon
              ...
              ; (injectivity', fv_inj)  <- unzip `fmap` mapM rn_injectivity injectivity
              ; return ((tycon', tyvars', kind', injectivity'), plusFVs (fv_kind : fv_inj)) }
  ...
  where
     ...
     -- JSTOLAREK: FreeVars here puzzle me a bit. Should there be any FreeVars
     -- generated by the definitions of injectivity conditions?
     rn_injectivity :: InjectivityInfo RdrName -> RnM (InjectivityInfo Name, FreeVars)
